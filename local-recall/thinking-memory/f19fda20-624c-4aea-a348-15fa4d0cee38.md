---
id: f19fda20-624c-4aea-a348-15fa4d0cee38
subject: >-
...
The MCP server uses `process.cwd()` as the project path. Let me add some debug logging to verify what's happening at runtime. But first, let me check the actual path the MCP server is seeing:
